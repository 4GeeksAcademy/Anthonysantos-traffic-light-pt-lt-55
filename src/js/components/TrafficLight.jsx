  ...
  return (
    ...
    <div className="d-flex justify-content-center align-items-center min-vh-100">
        ...
        <div className="d-flex flex-column align-items-center justify-content-center bg-black p-4" style={{ width: '15%' }}>
          <div onClick={changeRed} className={redBright ? 'brightRed' : ''} style={{backgroundColor: red, width: '100px', height: '100px', borderRadius: '50%', border: 'none', marginBottom: '20px',marginTop:'10px'}}>
          </div>
